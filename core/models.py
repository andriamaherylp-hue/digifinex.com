...
class TradingAccount(models.Model):
    """
    Multi trading account management for administrators.
    Keeps the existing trading logic intact while allowing
    ...
    def __str__(self):
        return f"{self.client.full_name} - {self.account_code}"
